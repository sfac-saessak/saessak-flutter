        ...
        body: Center(
          ...
          child: Column(
            ...
            children: [
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                  ...
                                  opacity: controller.selectedImage.value == null
                                      ? 0.2
                                      : 1.0,
                                  fit: controller.selectedImage.value == null
                                      ? null
                                      : BoxFit.cover)),
                        ),
                      ),
                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        child: CircleAvatar(
                          ...
                          backgroundColor: controller.selectedImage.value == null ? AppColor.lightGrey : AppColor.primary,
                        ),
                      ),
                    ),
                  ],
              ...
              SizedBox(height: 58),
              CustomTextField(controller: controller.nameController,hintText: '이름을 입력해주세요.', onChanged: controller.onChanged,),
            
              SizedBox(height: 16),
              Obx(()=> CustomButton(onPressed: controller.onTapStartBtn, text: '설정하기', isenableButton: controller.isEnableButton.value)),
